        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="sm:pl-72">
                ...
                <nav className="sticky top-0 z-30 border-b border-gray-100 bg-white">
                        ...
                        <div className="flex h-16 items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center justify-center rounded-md p-2 text-gray-500 hover:bg-gray-100 sm:hidden"
                    ...
                    {/* Mobile "quick links" under topbar */}
